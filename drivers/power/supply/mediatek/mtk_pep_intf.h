...
static int mtk_pep_init(void)
{
	return -ENOTSUPP;
}
static int mtk_pep_reset_ta_vchr(void)
{
	return -ENOTSUPP;
}
static int mtk_pep_check_charger(void)
{
	return -ENOTSUPP;
}
static int mtk_pep_start_algorithm(void)
{
	return -ENOTSUPP;
}
#if 0
static int mtk_pep_plugout_reset(void)
{
	return -ENOTSUPP;
}
#endif
static int mtk_pep_set_charging_current(enum CHR_CURRENT_ENUM *ichg,
					       enum CHR_CURRENT_ENUM *aicr)
{
	return -ENOTSUPP;
}

static void mtk_pep_set_to_check_chr_type(bool check)
{
}
static void mtk_pep_set_is_cable_out_occur(bool out)
{
}
static void mtk_pep_set_is_enable(bool enable)
{
}

static bool mtk_pep_get_to_check_chr_type(void)
{
	return false;
}
static bool mtk_pep_get_is_connect(void)
{
	return false;
}
static bool mtk_pep_get_is_enable(void)
{
	return false;
}
