...
static int mtk_pe20_init(struct charger_manager *pinfo)
{
	return -ENOTSUPP;
}

static int mtk_pe20_reset_ta_vchr(struct charger_manager *pinfo)
{
	return -ENOTSUPP;
}

static int mtk_pe20_check_charger(struct charger_manager *pinfo)
{
	return -ENOTSUPP;
}

static int mtk_pe20_start_algorithm(struct charger_manager *pinfo)
{
	return -ENOTSUPP;
}

static int mtk_pe20_set_charging_current(struct charger_manager *pinfo,
						unsigned int *ichg,
						unsigned int *aicr)
{
	return -ENOTSUPP;
...
static void mtk_pe20_set_to_check_chr_type(struct charger_manager *pinfo,
						  bool check)
{
}

static void mtk_pe20_set_is_enable(struct charger_manager *pinfo,
					   bool enable)
{
}
...
static bool mtk_pe20_get_to_check_chr_type(struct charger_manager *pinfo)
{
	return false;
}

static bool mtk_pe20_get_is_connect(struct charger_manager *pinfo)
{
	return false;
}

static bool mtk_pe20_get_is_enable(struct charger_manager *pinfo)
{
	return false;
}
