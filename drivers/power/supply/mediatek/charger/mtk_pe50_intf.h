...
#else
static int mtk_pe50_init(struct charger_manager *chgmgr)
{
	return -ENOTSUPP;
}

static bool mtk_pe50_is_ready(struct charger_manager *chgmgr)
{
	return false;
}

static int mtk_pe50_start(struct charger_manager *chgmgr)
{
	return -ENOTSUPP;
}

static bool mtk_pe50_is_running(struct charger_manager *chgmgr)
{
	return false;
}

static int mtk_pe50_plugout_reset(struct charger_manager *chgmgr)
{
	return -ENOTSUPP;
}

static bool mtk_pe50_get_is_connect(struct charger_manager *chgmgr)
{
	return false;
}

static bool mtk_pe50_get_is_enable(struct charger_manager *chgmgr)
{
	return false;
}

static void mtk_pe50_set_is_enable(struct charger_manager *chgmgr,
					  bool enable)
{
}

static int mtk_pe50_notifier_call(struct charger_manager *chgmgr,
					 enum mtk_pe50_notify_src src,
					 unsigned long event, void *data)
{
	return -ENOTSUPP;
...
static int mtk_pe50_deinit(struct charger_manager *chgmgr)
{
	return -ENOTSUPP;
}

static int mtk_pe50_thermal_throttling(struct charger_manager *chgmgr,
					      int uA)
{
	return -ENOTSUPP;
}

static int mtk_pe50_set_jeita_vbat_cv(struct charger_manager *chgmgr,
					     int uV)
{
	return -ENOTSUPP;
}

static int mtk_pe50_stop_algo(struct charger_manager *chgmgr, bool rerun)
{
	return -ENOTSUPP;
}
