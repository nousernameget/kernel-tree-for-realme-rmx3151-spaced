...
#else
static int lg4ff_adjust_input_event(struct hid_device *hid, struct hid_field *field,
					   struct hid_usage *usage, s32 value, struct lg_drv_data *drv_data) { return 0; }
static int lg4ff_raw_event(struct hid_device *hdev, struct hid_report *report,
