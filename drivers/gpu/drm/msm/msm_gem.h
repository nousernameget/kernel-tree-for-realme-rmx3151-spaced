...
static bool is_active(struct msm_gem_object *msm_obj)
{
	return msm_obj->gpu != NULL;
}

static bool is_purgeable(struct msm_gem_object *msm_obj)
{
...
static bool is_vunmapable(struct msm_gem_object *msm_obj)
{
