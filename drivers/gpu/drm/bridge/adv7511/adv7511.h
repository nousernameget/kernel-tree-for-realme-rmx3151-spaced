...
static void adv7533_mode_set(struct adv7511 *adv,
				    struct drm_display_mode *mode)
{
}

static int adv7533_patch_registers(struct adv7511 *adv)
{
	return -ENODEV;
}

static void adv7533_uninit_cec(struct adv7511 *adv)
{
}

static int adv7533_init_cec(struct adv7511 *adv)
{
	return -ENODEV;
}
...
static void adv7533_detach_dsi(struct adv7511 *adv)
{
}
...
static int adv7511_audio_init(struct device *dev, struct adv7511 *adv7511)
{
	return 0;
}
static void adv7511_audio_exit(struct adv7511 *adv7511)
{
}
