...
static void greybus_set_drvdata(struct gb_bundle *bundle, void *data)
{
	dev_set_drvdata(&bundle->dev, data);
}

static void *greybus_get_drvdata(struct gb_bundle *bundle)
{
...
static bool cport_id_valid(struct gb_host_device *hd, u16 cport_id)
{
