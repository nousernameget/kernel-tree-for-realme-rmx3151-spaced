...
static size_t cfs_size_round4(int val)
{
	return (val + 3) & (~0x3);
}

#ifndef HAVE_CFS_SIZE_ROUND
static size_t cfs_size_round(int val)
{
	return (val + 7) & (~0x7);
}
...
static size_t cfs_size_round16(int val)
{
	return (val + 0xf) & (~0xf);
}

static size_t cfs_size_round32(int val)
{
	return (val + 0x1f) & (~0x1f);
}

static size_t cfs_size_round0(int val)
{
	if (!val)
		return 0;
	return (val + 1 + 7) & (~0x7);
...
static size_t cfs_round_strlen(char *fset)
{
