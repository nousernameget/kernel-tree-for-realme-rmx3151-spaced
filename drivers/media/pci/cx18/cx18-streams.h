...
static bool cx18_stream_enabled(struct cx18_stream *s)
{
...
static void cx18_stream_load_fw_queue(struct cx18_stream *s)
{
	schedule_work(&s->out_work_order);
}

static void cx18_stream_put_mdl_fw(struct cx18_stream *s,
					  struct cx18_mdl *mdl)
{
