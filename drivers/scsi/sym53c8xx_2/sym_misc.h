...
static struct sym_quehead *sym_que_first(struct sym_quehead *head)
{
	return (head->flink == head) ? 0 : head->flink;
}

static struct sym_quehead *sym_que_last(struct sym_quehead *head)
{
	return (head->blink == head) ? 0 : head->blink;
}

static void __sym_que_add(struct sym_quehead * new,
...
static void __sym_que_del(struct sym_quehead * blink,
	struct sym_quehead * flink)
{
	flink->blink = blink;
	blink->flink = flink;
...
static int sym_que_empty(struct sym_quehead *head)
{
	return head->flink == head;
}

static void sym_que_splice(struct sym_quehead *list,
...
static void sym_que_move(struct sym_quehead *orig,
...
static struct sym_quehead *sym_remque_head(struct sym_quehead *head)
{
...
static struct sym_quehead *sym_remque_tail(struct sym_quehead *head)
{
