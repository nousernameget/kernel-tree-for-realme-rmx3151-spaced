...
static dm_oblock_t to_oblock(dm_block_t b)
{
	return (__force dm_oblock_t) b;
}

static dm_block_t from_oblock(dm_oblock_t b)
{
	return (__force dm_block_t) b;
}

static dm_cblock_t to_cblock(uint32_t b)
{
	return (__force dm_cblock_t) b;
}

static uint32_t from_cblock(dm_cblock_t b)
{
	return (__force uint32_t) b;
}

static dm_dblock_t to_dblock(dm_block_t b)
{
	return (__force dm_dblock_t) b;
}

static dm_block_t from_dblock(dm_dblock_t b)
{
	return (__force dm_block_t) b;
}
