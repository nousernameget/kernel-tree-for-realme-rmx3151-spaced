...
static bool cqhci_crypto_enable(struct cmdq_host *host)
{
	return false;
}

static int cqhci_host_init_crypto(struct cmdq_host *host)
{
	return 0;
}

static int cqhci_prep_crypto_desc(struct mmc_request *mrq,
					 __le64 *task_desc)
{
	return 0;
}
