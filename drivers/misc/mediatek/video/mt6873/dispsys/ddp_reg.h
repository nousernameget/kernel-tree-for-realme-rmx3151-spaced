...
#define DISPSYS_DSC_WRAP0_CORE1_BASE \
	ddp_get_module_va(DISP_MODULE_DSC_WRAP0_CORE1)
#define DISPSYS_DSI0_BASE ddp_get_module_va(DISP_MODULE_DSI0)
#define DISPSYS_WDMA0_BASE ddp_get_module_va(DISP_MODULE_WDMA0)
#define DISPSYS_UFBC_WDMA0_BASE ddp_get_module_va(DISP_MODULE_UFBC_WDMA0)
...
#define DISPSYS_MDP_HDR4_BASE ddp_get_module_va(DISP_MODULE_MDP_HDR4)
...
#define DISPSYS_MDP_TDSHP4_BASE ddp_get_module_va(DISP_MODULE_MDP_TDSHP4)
#define DISPSYS_MDP_COLOR4_BASE ddp_get_module_va(DISP_MODULE_MDP_COLOR4)
#define DISPSYS_Y2R0_BASE ddp_get_module_va(DISP_MODULE_Y2R0)

#define DISPSYS_PWM0_BASE ddp_get_module_va(DISP_MODULE_PWM0)
#define DISPSYS_DSIDUAL_BASE ddp_get_module_va(DISP_MODULE_DSIDUAL)
