...
#else
static int watchdog_register_pretimeout(struct watchdog_device *wdd)
{
	return 0;
}

static void watchdog_unregister_pretimeout(struct watchdog_device *wdd)
{
}

static int watchdog_pretimeout_available_governors_get(char *buf)
{
	return -EINVAL;
}

static int watchdog_pretimeout_governor_get(struct watchdog_device *wdd,
						   char *buf)
{
	return -EINVAL;
}

static int watchdog_pretimeout_governor_set(struct watchdog_device *wdd,
						   const char *buf)
{
	return -EINVAL;
}
